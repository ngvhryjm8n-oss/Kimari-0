...
Sono sei query **indipendenti**: si lancia una alla volta, selezionando il
blocco. La 1 (le funzioni) è quella che serve di più — con quella si sbloccano
le 12 verifiche RPC che oggi restano appese. Per ciascuna: Download CSV, salvare
in `supabase/` col nome scritto nel commento.
